class contrail::common {
  ...
  exec { 
    'create-python-api-env':
      ...
      require  => Package['supervisor','python-novaclient','python-keystoneclient','python-quantumclient','contrail-api-lib','contrail-api-extension','contrail-config','contrail-setup','python-psutil','euca2ools','m2crypto'],
      provider => 'shell',
