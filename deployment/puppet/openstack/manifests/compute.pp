...
class openstack::compute (
  ...
  if $::fuel_settings['deployment_mode'] == 'multinode' {
    class { 'contrail::vrouter':
       ...
       control_instances_number    => $neutron_config['contrail']['control_instances_number'],
       collector_ip                => $neutron_config['contrail']['collector_ip'],
       api_ip                      => $neutron_config['contrail']['api_ip'],
       vrouter_ip                  => $neutron_config['contrail']['vrouter_ip'],
       vrouter_dec_mask            => $neutron_config['contrail']['vrouter_dec_mask'],
       vrouter_prefix              => $neutron_config['contrail']['vrouter_prefix'],
       vrouter_ifname              => $neutron_config['contrail']['vrouter_ifname'],
       vrouter_hwaddr              => $neutron_config['contrail']['vrouter_hwaddr'],
       host_ip                     => $neutron_config['contrail']['host_ip'],
       # gateway_ip                  => $neutron_config['contrail'][],
       # dns                         => $neutron_config['contrail']['dns'],
       ...
       service_token               => $neutron_config['contrail']['admin_password'],
       quantum_ip                  => $neutron_config['contrail']['quantum_ip'],
       openstack_controller_ip     => $neutron_config['contrail']['quantum_ip'],
       admin_token                 => $neutron_config['keystone']['admin_password'],
       host_ip_list                => $neutron_config['contrail']['hosts_ip_list_mgmt'],
